...
face_cascade = cv2.CascadeClassifier('D:\\App files\\Face_Mask_Detection\\data\\xml\\haarcascade_frontalface_default.xml')
eye_cascade = cv2.CascadeClassifier('data\\xml\\haarcascade_eye.xml')
mouth_cascade = cv2.CascadeClassifier('D:\\App files\\Face_Mask_Detection\\data\\xml\\haarcascade_mcs_mouth.xml')
